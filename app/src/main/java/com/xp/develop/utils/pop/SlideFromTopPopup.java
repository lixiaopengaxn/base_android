...
//        ListView listView = (ListView) findViewById(R.id.ok);
    ...
    private static class InnerPopupAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.popup_dialog, parent, false);
                vh.mTextView = (TextView) convertView.findViewById(R.id.cancel);
