package com.xp.develop.utils.pulltoview.header.bezierlayout;
...
import com.xp.develop.utils.pulltoview.IHeaderView;
import com.xp.develop.utils.pulltoview.OnAnimEndListener;
...
public class BezierLayout extends FrameLayout implements IHeaderView {
    ...
    private void init(AttributeSet attrs) {
         ...
         * 初始化headView
         */
        headView = LayoutInflater.from(getContext()).inflate(R.layout.pull_to_view_bezier, null);
